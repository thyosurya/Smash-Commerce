        ...
        return match ($this->status) {
            ...
            'processing' => implode("\n", [
                ...
                $order->shipping_method === 'pickup' 
                    ? "Kami akan segera memberitahu kamu saat pesanan siap diambil di toko. ✅"
            ...
            'ready_for_pickup' => implode("\n", [
                "🏪 *Pesanan Siap Diambil!*",
                "━━━━━━━━━━━━━━━━━━━━",
                "Halo *{$name}*! Pesanan kamu sudah siap untuk diambil di toko kami! 🎉",
                "",
                "📦 *Order ID:* {$orderId}",
                "💳 *Total:* {$total}",
                "🚚 *Metode:* Ambil di Toko",
                "",
                "Silakan datang ke toko kami dengan menunjukkan pesan ini atau nomor pesanan.",
                "",
            ...
            'picked_up' => implode("\n", [
                ...
                "━━━━━━━━━━━━━━━━━━━━",
                "Halo *{$name}*! Terima kasih sudah mengambil pesananmu di toko! 🎉",
                "",
                "📦 *Order ID:* {$orderId}",
                "💳 *Total:* {$total}",
                "",
