    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: '#0A1628', fontFamily: "'Poppins', sans-serif" }}>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm mt-1" style={{ color: '#64748B' }}>We'll send you a reset link</p>
        </div>
          ...
          {!sent ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button type="submit" disabled={loading}
                ...
                {loading ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin" /> : <><Send size={15} /><span>Send Reset Link</span></>}
              </button>
            </form>
          ) : (
            <div className="text-center py-4">
              ...
              <p className="text-sm mb-4" style={{ color: '#64748B' }}>
                We've sent a reset link to <span style={{ color: '#22D3EE' }}>{email}</span>
              </p>
              <p className="text-xs mb-5" style={{ color: '#64748B' }}>Check your inbox and follow the instructions. Link expires in 15 minutes.</p>
