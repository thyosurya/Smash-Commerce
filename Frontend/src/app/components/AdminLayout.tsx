...
import { BarChart3, Users, Package, FileText, Settings, LogOut, FileBarChart2, ChevronRight, Menu, Zap, Wrench, ShoppingBag } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { icon: Users,         label: 'Analitik Pengguna', path: '/admin/users' },
  { icon: Package,       label: 'Produk',            path: '/admin/products' },
  { icon: ShoppingBag,   label: 'Pesanan',           path: '/admin/orders' },
  { icon: Wrench,        label: 'Jasa Pasang Senar', path: '/admin/stringing-service' },
  { icon: FileText,      label: 'Log Audit',         path: '/admin/audit' },
  { icon: Settings,      label: 'Pengaturan CRM',    path: '/admin/crm' },
];
